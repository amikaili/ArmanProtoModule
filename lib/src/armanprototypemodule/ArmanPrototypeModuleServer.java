 ...
 * </pre>
 */
public class ArmanPrototypeModuleServer extends JsonServerServlet {
    ...
    public ArmanPrototypeModuleServer() throws Exception {
        super("armanPrototypeModule");
        //BEGIN_CONSTRUCTOR
     ...
     */
    @JsonServerMethod(rpc = "armanPrototypeModule.filter_contigs", async=true)
    ...
    @JsonServerMethod(rpc = "armanPrototypeModule.status")
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1) {
            new ArmanPrototypeModuleServer().startupServer(Integer.parseInt(args[0]));
        } else if (args.length == 3) {
            JsonServerSyslog.setStaticUseSyslog(false);
            JsonServerSyslog.setStaticMlogFile(args[1] + ".log");
            new ArmanPrototypeModuleServer().processRpcCall(new File(args[0]), new File(args[1]), args[2]);
        } else {
