package armanprototypemodule.test;
...
import armanprototypemodule.FilterContigsParams;
import armanprototypemodule.FilterContigsResults;
import armanprototypemodule.ArmanPrototypeModuleServer;
...
public class ArmanPrototypeModuleServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static ArmanPrototypeModuleServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("armanPrototypeModule");
        // Token validation
        ...
        JsonServerSyslog.setStaticMlogFile(new File(config.get("scratch"), "test.log")
            .getAbsolutePath());
        impl = new ArmanPrototypeModuleServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_ArmanPrototypeModule_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("armanPrototypeModule").withMethod("please_never_use_it_in_production")
